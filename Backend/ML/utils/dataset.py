...
def load_images_and_labels(dataset_path: str = 'Dataset_formatted', test_size: float = 0.1,
...
class Dataset(object):
    ...
    def get_dataset(self):
        ...
        (self.X_train, self.y_train), (self.X_test, self.y_test) = load_images_and_labels()
        # prepares the data
