"""
The tests won't work, because the working directory is different from when running the application.
To make the tests work do:
    1. Go to endpoint.py in Backend directory
    2. Change model_path = "ML/bin/model.keras"   to   model_path = "../../ML/bin/model.keras"
    3. Make sure to change back when running the actual application
"""
