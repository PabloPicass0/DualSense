...
def fit_bezier_for_z_cubic():
    ...
    # # Code below plots the touch locations of the user
    # # splits the locations into x and y coordinates
    # x, y = zip(*locations)
    #
    # # plots the locations
...
def is_sign_z_cubic(timestamps: List[float], locations: List[List[float]]) -> bool:
    ...
    # saves the plot
    current_dir = os.path.dirname(os.path.abspath(__file__))
    filename = os.path.join(current_dir, 'output_figure_cubic.png')
